...
public final class ProviderCard {
    ...
    public void render(GuiGraphics graphics, Font font, int mouseX, int mouseY, boolean selected, boolean hasKey) {
        ...
        graphics.drawString(font, provider, x + 10, y + 10, selected ? UiTheme.PRIMARY : UiTheme.TEXT, false);
