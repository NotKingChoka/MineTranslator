package net.kingchoka.minetranslator.config.neoforge;
...
/**
 * The NeoForge-sided implementation of {@link MTConfig}.
 * To get config values, use {@link MTConfig#getInstance()}.
 */
@ApiStatus.Internal
@EventBusSubscriber(modid = MineTranslator.ID)
public class MTConfigImplNeoForge implements MTConfig {

    public static final MTConfigImplNeoForge INSTANCE;
    public static final ModConfigSpec SPEC;
    public static final Map<String, String> FIRST_CHILD_TO_CATEGORY = new HashMap<>();

    static {
        final Pair<MTConfigImplNeoForge, ModConfigSpec> configPair = new ModConfigSpec.Builder().configure(MTConfigImplNeoForge::new);
    ...
    private MTConfigImplNeoForge(ModConfigSpec.Builder builder) {
        ...
        this.autoTranslateChat = builder
                .translation("config.minetranslator.auto_translate_chat")
        ...
        this.autoTranslateNpc = builder
                .translation("config.minetranslator.auto_translate_npc")
        ...
        this.useNpcContextOnly = builder
                .translation("config.minetranslator.use_npc_context_only")
        ...
        this.translationContextSize = builder
                .translation("config.minetranslator.translation_context_size")
        ...
        this.showOriginalWithTranslation = builder
                .translation("config.minetranslator.show_original_with_translation")
        ...
        this.preserveFormatting = builder
                .translation("config.minetranslator.preserve_formatting")
        ...
        this.translatePlayerMessages = builder
                .translation("config.minetranslator.translate_player_messages")
        ...
        this.preserveGameTermsInPlayerChat = builder
                .translation("config.minetranslator.preserve_game_terms_in_player_chat")
        ...
        this.showPlayerOriginalWithTranslation = builder
                .translation("config.minetranslator.show_player_original_with_translation")
        ...
        this.fastTranslationMode = builder
                .translation("config.minetranslator.fast_translation_mode")
        ...
        this.preloadChatTranslations = builder
                .translation("config.minetranslator.preload_chat_translations")
        ...
        this.preloadTooltipTranslations = builder
                .translation("config.minetranslator.preload_tooltip_translations")
        ...
        this.maxCacheSize = builder
                .translation("config.minetranslator.max_cache_size")
        ...
        this.translateMyMessagesBeforeSending = builder
                .translation("config.minetranslator.translate_my_messages_before_sending")
                .define("translate_my_messages_before_sending", Default.translateMyMessagesBeforeSending);

        this.myMessageTargetLanguage = builder
                .translation("config.minetranslator.my_message_target_language")
        ...
        this.showTranslationPreviewBeforeSending = builder
                .translation("config.minetranslator.show_translation_preview_before_sending")
        ...
        this.deeplApiKey = builder
                .translation("config.minetranslator.deepl_apikey")
        ...
        this.geminiApiKey = builder
                .translation("config.minetranslator.gemini_apikey")
                .define("gemini_apikey", Default.geminiApiKey);

        this.geminiBaseUrl = builder
                .translation("config.minetranslator.gemini_baseurl")
                .define("gemini_baseurl", Default.geminiBaseUrl);

        this.geminiModel = builder
                .translation("config.minetranslator.gemini_model")
        ...
        this.claudeApiKey = builder
                .translation("config.minetranslator.claude_apikey")
                .define("claude_apikey", Default.claudeApiKey);

        this.claudeBaseUrl = builder
                .translation("config.minetranslator.claude_baseurl")
                .define("claude_baseurl", Default.claudeBaseUrl);

        this.claudeModel = builder
                .translation("config.minetranslator.claude_model")
    ...
    public static void init(ModContainer container) {
        ...
        // Migration logic:
        try {
            java.nio.file.Path configPath = FMLPaths.CONFIGDIR.get().resolve("MineTranslator.toml");
            ...
            MineTranslator.LOGGER.error("Failed to migrate config: {}", e.toString());
        }
    ...
    private static void moveOldConfigToNew() {
        ...
        var oConfigFile = configDir.resolve("MineTranslator-client.toml");
        var configFile = configDir.resolve("MineTranslator.toml");
        try {
