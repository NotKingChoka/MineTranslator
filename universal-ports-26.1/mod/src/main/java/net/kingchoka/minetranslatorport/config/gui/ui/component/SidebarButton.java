...
public final class SidebarButton {
    ...
    public void render(GuiGraphicsExtractor graphics, Font font, int mouseX, int mouseY, boolean selected, float partialTick) {
        ...
        graphics.text(font, icon, x + 8, y + (height - font.lineHeight) / 2, selected ? UiTheme.PRIMARY : UiTheme.MUTED, false);
