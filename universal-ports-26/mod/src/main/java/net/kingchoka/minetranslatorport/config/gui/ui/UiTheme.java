...
public final class UiTheme {
    ...
    public static void panel(GuiGraphicsExtractor graphics, int x, int y, int width, int height, int color) {
    ...
    public static void roundedFill(GuiGraphicsExtractor graphics, int x, int y, int width, int height, int color) {
    ...
    public static void drawEllipsizedText(
        GuiGraphicsExtractor graphics, Font font, Component text, int x, int y, int maxWidth, int color
    ) {
        ...
        graphics.text(font, clipped + ellipsis, x, y, color, false);
    }
