...
public final class ConfirmDialog {
    public void render(GuiGraphicsExtractor g, Font f, int screenW, int screenH, Component title, Component description) {
        ...
        g.text(f,title,x+14,y+14,UiTheme.TEXT,false);
