package net.kingchoka.minetranslator.compat.clothconfig;
...
import net.kingchoka.minetranslator.api.ITPPClothConfigData;
...
/**
 * The ClothConfig-compatible implementation of {@link MTConfig}.
 * To get config values, use {@link MTConfig#getInstance()}.
 */
@ApiStatus.Internal
public class MTConfigImplCloth implements MTConfig {
    private static ConfigHolder<MTConfigData> holder;

    public MTConfigImplCloth() {
    }
    ...
    public static MTConfigData config() {
    ...
    public static void init() {
        // Migration logic:
        try {
            java.nio.file.Path configPath = java.nio.file.Paths.get("config").resolve("MineTranslator.toml");
        ...
        holder = AutoConfig.register(MTConfigData.class, Toml4jConfigSerializer::new);
    ...
    @Config(name = MineTranslator.ID)
    public static final class MTConfigData implements ITPPClothConfigData {
